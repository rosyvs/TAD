#!/usr/bin/python3
"""Recipe for training speaker embeddings (e.g, xvectors) using the kids speech enhanced dataset.
...
def dataio_prep(hparams):
    ...
    @sb.utils.data_pipeline.provides("speaker", "spk_id_encoded")
    def label_pipeline(speaker):
        yield speaker
        spk_id_encoded = label_encoder.encode_sequence_torch([speaker])
    ...
    label_encoder.load_or_create(
        path=lab_enc_file, from_didatasets=[train_data], output_key="speaker",
    )
